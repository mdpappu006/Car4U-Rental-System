<?php
	...
	{
		$vimage1=$_FILES["img2"]["name"];
		$imgID=intval($_GET['imgid']);
		move_uploaded_file($_FILES["img1"]["tmp_name"],"img/vehicleimages/".$_FILES["img2"]["name"]);
		$sql="update tblvehicles set Vimage1='{$vimage1}' where id='{$imgID}'";
